...
docker exec -it consul consul services register -name=MySql -address=YOUR_IP -port=3306
docker exec -it consul consul services register -name=MongoDb -address=YOUR_IP -port=27017
